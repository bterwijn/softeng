...
def main():
    ...
    parser.add_argument("-p1", type=str,
                        help="""type of player1: 'h' (human, default), 'r' (random), 'a1' (AI 1 move), 'a2' (AI 2 moves)""", default="h")
    parser.add_argument("-p2", type=str,
                        help="""type of player2: 'h' (human), 'r' (random, default), 'a1' (AI 1 move), 'a2' (AI 2 moves)""", default="r")
